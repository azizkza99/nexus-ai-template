...
export default function Footer({ lang }) {
  ...
  return (
    <footer className="border-t border-slate-900 bg-slate-950 px-4 py-12 text-center sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <p className="text-xs font-semibold text-indigo-400">{currentText.trust}</p>
